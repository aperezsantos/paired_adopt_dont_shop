...
RSpec.describe "When I visit an applications show page", type: :feature do
  it "I can approve applications per specific pet" do
    ...
    application2 = Application.create!(name: "Tim", address: "test address", city: "test city", state: "test state", zip: "test zipcode", phone_number: "test phone number", description: "test description")
  ...
  it "I can approve the application for multiple pets at once" do
    ...
    click_button ("Approve Application for Selected Pets")
  ...
  it "Cant approve applications for pets, that are pending adoption" do
